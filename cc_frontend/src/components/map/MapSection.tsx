...
export default function LeafletMap({ targetLocation }: any) {
  return (
    <MapContainer 
      ...
      className="z-0"
    >
      {/* 1. BASE LAYER: Satellite Imagery (The background) */}
      <TileLayer 
        url="https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}" 
        attribution='&copy; Esri'
      />

      {/* 2. OVERLAY LAYER: Labels & Borders (The text) */}
      {/* This adds city names, state borders, and main roads on top of the satellite image */}
      <TileLayer 
